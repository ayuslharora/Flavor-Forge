...
function Search() {
                ...
                <div className="grow flex justify-center items-center">
                    <div className="flex flex-col items-center gap-4 bg-red-500/10 border border-red-500/20 px-8 py-6 rounded-2xl">
                        ...
                        <div className="text-xl font-medium tracking-wide text-red-400 text-center">
                            No recipes found for "<span className="text-white font-bold">{search}</span>"
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className='bg-slate-950 min-h-screen font-sans text-slate-100 flex flex-col'>
            ...
            <div className="w-full max-w-7xl mx-auto px-4 mt-12 mb-8 text-center grow">
                ...
                <div className="h-1 w-24 bg-linear-to-r from-emerald-400 to-cyan-400 mt-6 mx-auto rounded-full shadow-[0_0_30px_rgba(34,211,238,0.5)] mb-10"></div>
